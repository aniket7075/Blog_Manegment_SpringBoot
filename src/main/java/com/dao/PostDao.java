...
public class PostDao {
	...
	public int savePost(Post post)
	{
		...
		try {
		    String query = post.getImage().isEmpty() 
		                   ? "INSERT INTO post(title, content, code, cid, id) VALUES(?, ?, ?, ?, ?)" 
		                   : "INSERT INTO post(title, content, code, cid, id, image) VALUES(?, ?, ?, ?, ?, ?)";
